...
<body>
    ...
    <main>
        <form action="" method="post">
            ...
            <button type="button" class="btn" id="finish" onclick="rta()">Finalizar</button>
            <span style="font-size:14px" id="send">Enviar por email.</span>
        </form>
    </main>
    ...
    $("#send").click(function()
    {
        $.get("send_mail.php", { 'sel[]': [$("#pregunta1").val(), '1'] } , function(data) 
        {
            if(data == 100)
            {
                $("#send").html("Felicitaciones funciona.");
            }
            else $("#send").html("ERROR.");
        });
    });
    </script>
</body>
